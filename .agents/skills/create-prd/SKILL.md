---
name: create-prd
description: Use when requirements already exist in conversation and Codex should formalize them into a PRD under .agents/PRDs/.
---
...
**Output name**: derive a kebab-case name from the product or feature unless the user supplied an explicit name
...
3. Generate stories: `create-stories {prd-path}`
4. Prime context: `prime`
5. Create implementation plan: `plan {story-or-issue}`
```
