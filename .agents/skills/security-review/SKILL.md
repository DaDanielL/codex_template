...
description: Use when code changes need a security-focused review for vulnerabilities, data exposure, auth, and configuration risks.
---
...
**Input**: the user request, supplied path, issue or PR reference, or current conversation context (defaults to staged git changes if no path provided)
...
0. Read `AGENTS.md` for project-specific security, validation, and architecture rules
