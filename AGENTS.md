...
rg -n "AGENTS.md|GitHub Issue|gh issue view|gh issue create|gh issue comment|gh pr create|gh pr view|to-issues|.agents/PRDs|.agents/stories|.agents/plans" .agents README.md AGENTS.md
```
...
- Prefer `gh issue view`, `gh issue create`, `gh issue comment`, `gh pr create`, and `gh pr view` where useful.
